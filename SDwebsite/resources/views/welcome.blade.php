                ...
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    ...
                    @if (Route::has('login'))
                        <div class="ml-4 text-center text-sm text-gray-500 sm:text-center sm:ml-0">
                            @auth
                                <a href="{{ url('/home') }}" class="text-lg text-gray-1000 underline">Home</a>
                            @else
                                <a href="{{ route('login') }}" class="text-lg text-gray-1000 underline">Log in</a>

                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}" class="ml-4 text-lg text-gray-1000 underline">Register</a>
                                @endif
                            @endauth
                        </div>
                    @endif
